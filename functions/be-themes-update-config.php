...
if (!class_exists('Redux_Framework_BE_update_config')) {
    ...
    class Redux_Framework_BE_update_config {
        ...
        public function setSections() {
            ...
            // General Settings
            $this->sections[] = array(
                'title'     => __('Purchase Code', 'be-themes'),
                'desc'      => '',//__('Enter the Themeforest Purchase code here. This will be used to validate and enable the Theme Auto Update feature.', 'be-themes'),
                'icon'      => 'el-icon-adjust-alt',
                'fields'    => array(
                    array (
                        'id' => 'theme_purchase_code',
                        'type' => 'text',
                        'title' => __('Enter Code', 'be-themes'), 
                        'subtitle' => __('You can find the code here', 'be-themes'),
                        'desc' => __('', 'be-themes'),
                        'default' => ''
                        ),
                ),
        ...
        public function setArguments() {
            ...
            $this->args = array(
                ...
                'menu_title'        => __('Oshin Purchase Code', 'be-themes'),
                'page_title'        => __('Oshin Purchase Code', 'be-themes'),
